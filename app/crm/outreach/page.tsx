...
export default function OutreachPage() {
  ...
  const addProspectToTeamQueue = async (prospect: Prospect) => {
    ...
    try {
      ...
      if (!window.confirm(
        "This person was contacted through another campaign within the last 30 days. Override the safety pause and record why?"
      )) throw new Error("The 30 day campaign safety pause remains in place");
      const reason = window.prompt(
        "Why is contacting this person again appropriate? This reason is saved in the outreach history."
      )?.trim();
