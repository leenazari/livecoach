    ...
    <main className="relative z-10 mx-auto max-w-[1180px] px-3 py-5 sm:px-5 sm:py-9">
      ...
      {!loading && !tabLoading && tab === "signals" ? <section className="space-y-4">
        <div className="rounded-xl border border-amber/40 bg-amber/[0.06] p-4">
          ...
          <div className="mt-3 rounded-lg border border-moss/35 bg-moss/[0.06] p-3 text-xs leading-5 text-bone/75"><strong className="text-moss">No LinkedIn scraping or account connection.</strong> LiveCoach only reads the words you paste. You review the comment, copy it and post it yourself.</div>
