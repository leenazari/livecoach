...
export default function OutreachPage() {
  ...
  const rehearse = async (messageId: string) => {
    ...
    try {
      ...
      if (!result.ok || (sender?.mailboxEmail && result.sentTo !== sender.mailboxEmail) || result.campaignChanged !== false) throw new Error("The safe rehearsal was not confirmed");
