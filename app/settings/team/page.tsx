        ...
        <div className="space-y-5">
          <section className="rounded-2xl border border-sage/40 bg-sage/[0.06] p-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                <Link
                  href="/settings/team/privacy"
                  className="rounded-full border border-rust/50 bg-rust/10 px-4 py-2 font-mono text-[0.58rem] uppercase tracking-wider text-rust"
                >
                  Privacy review
                </Link>
                <Link
                  ...
                  <div className="rounded-xl border border-edge bg-panel/55 p-3">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <span className={`rounded-full border px-2 py-1 font-mono text-[0.54rem] uppercase tracking-wider ${member.transcriberUsage.activeBot ? "border-sage/50 bg-sage/10 text-sage" : "border-edge text-muted"}`}>
                        {member.transcriberUsage.activeBot ? "Live now" : "Shared capture ready"}
                      </span>
                    </div>
                    ...
                    <p className="mt-2 text-xs leading-5 text-muted">
                      One notetaker can securely serve teammates on the same scheduled meeting. Each person's agenda, live coaching, notes and summary stay private.
                    </p>
