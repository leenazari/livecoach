-- The function returns a field named workspace_id. PostgreSQL therefore
-- treated the previous ON CONFLICT (workspace_id, user_id) target as
-- ambiguous. Referencing the existing primary-key constraint is explicit and
-- keeps invitation acceptance idempotent.
