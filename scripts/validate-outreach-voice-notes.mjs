...
assert.match(returnToInbox, /Close and return to email/);
assert.match(returnToInbox, /This page never opens or/);
assert.match(returnToInbox, /Close this\s*tab to return to the email you were reading/);
assert.doesNotMatch(returnToInbox, /mailto:/);
assert.doesNotMatch(returnToInbox, /window\.location\.assign/);
assert.doesNotMatch(returnToInbox, /navigator\.clipboard/);
